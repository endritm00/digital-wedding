          ...
          <main style={{ background: theme.wash }}>
            ...
            <footer className="py-20" style={{ background: theme.dark ? theme.washAlt : '#1A1816' }}>
              <div className={`flex flex-col gap-4 w-full px-8 ${theme.layout === 'editorial' ? 'items-start text-left' : 'items-center text-center'}`} style={{ maxWidth: layoutStyle(theme).maxW, margin: '0 auto' }}>
                ...
                <p className="font-inter mt-4" style={{ fontSize: 9, letterSpacing: '0.2em', color: 'rgba(253,252,249,0.18)', textTransform: 'uppercase' }}><a href="https://bellenuit.app" target="_blank" rel="noopener noreferrer" style={{ color: 'inherit', textDecoration: 'none' }}>Made with Belle Nuit</a></p>
              </div>
            </footer>
          </main>
        </RsvpCtx.Provider>
