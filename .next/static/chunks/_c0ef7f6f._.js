...
"[project]/lib/video/use-film-video.ts [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";

var { g: global, __dirname, k: __turbopack_refresh__, m: module } = __turbopack_context__;
{
__turbopack_context__.s({
    "useFilmVideo": (()=>useFilmVideo)
});
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/index.js [app-client] (ecmascript)");
var _s = __turbopack_context__.k.signature();
'use client';
...
function loadHls() {
    if (!hlsCtorPromise) {
        hlsCtorPromise = __turbopack_context__.r("[project]/node_modules/hls.js/dist/hls.mjs [app-client] (ecmascript, async loader)")(__turbopack_context__.i).then((m)=>m.default).catch(()=>null);
    }
    return hlsCtorPromise;
}
function useFilmVideo(ref, sources, { play = true, reduced = false } = {}) {
    _s();
    const [needsTap, setNeedsTap] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useFilmVideo.useEffect": ()=>{
            const video = ref.current;
            if (!video || !hls && !mp4) return;
            let destroyed = false;
            let hlsInstance = null;
            const setMp4 = {
                "useFilmVideo.useEffect.setMp4": ()=>{
                    ...
                    "useFilmVideo.useEffect": (Hls)=>{
                        ...
                        try {
                            ...
                            hlsInstance.on(Hls.Events.ERROR, {
                                "useFilmVideo.useEffect": (_e, data)=>{
                                    if (data.fatal) {
                                        try {
                                            hlsInstance?.destroy();
                                        } catch  {}
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useFilmVideo.useEffect": ()=>{
            ...
            const armGesture = {
                "useFilmVideo.useEffect.armGesture": ()=>{
                    if (removeGesture) return;
                    setNeedsTap(true);
                    const onGesture = {
                        "useFilmVideo.useEffect.armGesture.onGesture": ()=>{
                            video.play().then({
                                "useFilmVideo.useEffect.armGesture.onGesture": ()=>{
                                    setNeedsTap(false);
                                    removeGesture?.();
                                }
                            }["useFilmVideo.useEffect.armGesture.onGesture"]).catch({
                                "useFilmVideo.useEffect.armGesture.onGesture": ()=>{}
                            }["useFilmVideo.useEffect.armGesture.onGesture"]);
                        }
                    }["useFilmVideo.useEffect.armGesture.onGesture"];
                    ...
                    events.forEach({
                        "useFilmVideo.useEffect.armGesture": (e)=>document.addEventListener(e, onGesture, {
                                passive: true
                            })
                    }["useFilmVideo.useEffect.armGesture"]);
                    removeGesture = ({
                        "useFilmVideo.useEffect.armGesture": ()=>{
                            events.forEach({
                                "useFilmVideo.useEffect.armGesture": (e)=>document.removeEventListener(e, onGesture)
                            }["useFilmVideo.useEffect.armGesture"]);
                            removeGesture = null;
                        }
                    })["useFilmVideo.useEffect.armGesture"];
            ...
            const tryPlay = {
                "useFilmVideo.useEffect.tryPlay": ()=>{
                    if (cleanedUp) return;
                    const p = video.play();
                    if (p && typeof p.then === 'function') {
                        p.then({
                            "useFilmVideo.useEffect.tryPlay": ()=>setNeedsTap(false)
                        }["useFilmVideo.useEffect.tryPlay"]).catch({
                            "useFilmVideo.useEffect.tryPlay": ()=>armGesture()
                        }["useFilmVideo.useEffect.tryPlay"]);
                    }
                }
            }["useFilmVideo.useEffect.tryPlay"];
            const onLoaded = {
                "useFilmVideo.useEffect.onLoaded": ()=>tryPlay()
            }["useFilmVideo.useEffect.onLoaded"];
            const onVisible = {
                "useFilmVideo.useEffect.onVisible": ()=>{
...
_s(useFilmVideo, "i/0BdGJHj4Km+b/Qn9goPSsQQSA=");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
"[project]/components/invite/film-backdrop.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const COVER_MIN = 0.8;
function FilmBackdrop({ videoSrc, hlsSrc = null, poster, fallbackStyle, mode = 'auto', focal, autoPlay = true, reduced = false, className = '', videoRef: externalVideoRef }) {
    _s();
    ...
    const { needsTap, playNow } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$video$2f$use$2d$film$2d$video$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useFilmVideo"])(videoRef, {
        hls: hlsSrc,
        mp4: videoSrc
    }, {
        play: autoPlay,
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            fallbackStyle && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "absolute inset-0",
                style: fallbackStyle
            }, void 0, false, {
            ...
            videoSrc && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("video", {
                ...
                loop: true,
                playsInline: true
            }, hlsSrc ?? videoSrc, false, {
                fileName: "[project]/components/invite/film-backdrop.tsx",
                lineNumber: 128,
                columnNumber: 9
            }, this),
            videoSrc && needsTap && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                type: "button",
                onClick: playNow,
...
_s(FilmBackdrop, "FHAJhFuySVP7uSmOFsrJkhV2rRI=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$video$2f$use$2d$film$2d$video$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useFilmVideo"]
    ];
});
_c = FilmBackdrop;
var _c;
__turbopack_context__.k.register(_c, "FilmBackdrop");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$invite$2f$film$2d$backdrop$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/invite/film-backdrop.tsx [app-client] (ecmascript)");
...
function OpeningHero({ invite, opening, media, musicRef }) {
    ...
    const videoHls = uploadedAsset ? uploadedAsset.variants.hls ?? null : null;
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("section", {
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$invite$2f$film$2d$backdrop$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["FilmBackdrop"], {
                videoSrc: videoSrc,
                hlsSrc: videoHls,
                poster: posterImg,
                fallbackStyle: posterStyle,
                mode: uploadedAsset ? cfg.video_fit ?? 'blend' : 'auto',
                focal: cfg.video_focal ?? null,
                autoPlay: true,
                reduced: !!reduced
            }, void 0, false, {
                fileName: "[project]/app/invite/[id]/preview/page.tsx",
...
function PreviewPage() {
    ...
    const themeHls = openUploaded ? openUploaded.variants.hls ?? null : null;
                ...
                children: [
                    ...
                    state === 'ready' && invite && !opened && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$render$2f$components$2f$motion$2f$proxy$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["motion"].div, {
                        ...
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$invite$2f$openers$2f$index$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["InviteOpener"], {
                            ...
                            videoHls: themeHls,
                            poster: themePoster,
                            videoFit: openUploaded ? cfg.video_fit ?? 'blend' : 'auto',
                            videoFocal: cfg.video_focal ?? null,
                            onOpen: ()=>{
...
//# sourceMappingURL=_c0ef7f6f._.js.map