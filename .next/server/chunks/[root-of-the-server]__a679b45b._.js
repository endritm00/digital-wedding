...
"[project]/.next-internal/server/app/api/extras/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
"[project]/app/api/extras/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    ...
    const { data, error } = await supabase.from('extras').select('id, code, name, price_cents').eq('active', true).order('price_cents');
...
//# sourceMappingURL=%5Broot-of-the-server%5D__a679b45b._.js.map