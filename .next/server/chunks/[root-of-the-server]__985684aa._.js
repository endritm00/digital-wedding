...
"[project]/.next-internal/server/app/api/invites/[id]/extras/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
"[project]/app/api/invites/[id]/extras/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
;
;
const AddExtraSchema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].object({
    extra_id: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().uuid(),
    quantity: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].number().int().min(1).default(1)
});
async function GET(request, { params }) {
    ...
    const { data, error } = await db.from('invite_extras').select('id, extra_id, quantity, unit_price_cents, created_at, extras(code, name)').eq('invite_id', id);
...
async function POST(request, { params }) {
    ...
    const { data: extra, error: extraErr } = await db.from('extras').select('price_cents, active').eq('id', parsed.data.extra_id).single();
    if (extraErr || !extra) return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$response$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["badRequest"])('extra_not_found');
    if (!extra.active) return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$response$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["badRequest"])('extra_not_available');
    const { data, error } = await db.from('invite_extras').upsert({
        invite_id: id,
    ...
    }).select('id, extra_id, quantity, unit_price_cents').single();
    if (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__985684aa._.js.map