...
async function GET(request, { params }) {
    ...
    const service = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createServiceClient"])();
    const { data, error } = await service.from('media_assets').select(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mux$2f$reconcile$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ASSET_COLUMNS"]).eq('id', assetId).eq('invite_id', id).single();
    ...
    const reconciled = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mux$2f$reconcile$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["reconcileMuxAsset"])(data, id, service);
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$response$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ok"])(reconciled ?? data);
}
...
//# sourceMappingURL=%5Broot-of-the-server%5D__67e49be7._.js.map