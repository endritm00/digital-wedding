...
"[project]/.next-internal/server/app/api/plans/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
async function GET() {
    ...
    const { data, error } = await supabase.from('plans').select('id, code, name, base_price_cents, included_sections, sort_order').eq('active', true).order('sort_order');
...
//# sourceMappingURL=%5Broot-of-the-server%5D__b917fd85._.js.map